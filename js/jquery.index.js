    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $.each(data.waterfall, function(){
                ...
                var $intro = $("<p></p>").html(intro);
                $singleActivity.append($pic).append($title).append($time).append($place).append($intro).hide().appendTo($waterfall);
