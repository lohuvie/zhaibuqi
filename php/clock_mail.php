        ...
        $mail->IsHTML(true); // set email format to HTML //是否使用HTML格式
                ...
                $mail->Body = '<html>
                    <body>
                        ...
                        <tbody style="background:#ffffff;text-align:left;font-size:14px;color:#000000;font-family: "Microsoft Yahei","Helvetica Neue","Luxi Sans","DejaVu Sans",Tahoma,"Hiragino S6ns GB";line-height:19px;vertical-align:middle;width:99%;">
